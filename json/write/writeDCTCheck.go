...
func checkDCTDataToOJ(dctItems []*mj.CheckDCTData, moreDCTTokensAllowed bool) *oj.OJsonMap {
...
func checkDCTItemToOJ(dctItem *mj.CheckDCTData) oj.OJsonObject {
...
func appendCheckDCTInstanceToOJ(dctInstance *mj.CheckDCTInstance, targetOj *oj.OJsonMap) {
...
func isCompactCheckDCT(dctItem *mj.CheckDCTData) bool {
